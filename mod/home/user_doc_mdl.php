...
//--------------FIELDS TO BE INCLUDED IN TOOLBAR----------------
   'TOOLBAR'=>array(
      "page_id"=>array(
         ...
         "required"	=>"true",
         "onChange"  =>'set_param(this.id,this.value,this.displayedValue)',
         "onChange"  =>'s_p_c_add("ok",reload_main,this.value);set_param(this.id,this.value,this.displayedValue)',
