...
$query="SELECT registration_no FROM ".$GLOBALS['MOD_P_TABLES']['validation']." WHERE validation=1 AND admission_generated=0";
...
while($row=mysql_fetch_assoc($res)){
	...
	*/
	...
	$query="UPDATE ".$GLOBALS['MOD_P_TABLES']['validation']." SET admission_generated=1 WHERE registration_no='".$row['registration_no']."'";
