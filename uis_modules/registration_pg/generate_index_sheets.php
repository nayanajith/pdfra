...
include(MOD_CLASSES.'/index_list_pdf_class.php');

$date			='20-02-2011';
$duration	='10.00am-12.00noon';

$attendance_sheets=new Index_list($date,$duration);
...
$attendance_sheets->generate_index_lists($res);

/*Acquire pdf document*/
$pdf=$attendance_sheets->getPdf();

$pdf_file=A_RPT."/".$_SESSION['user_id']."-index_list.pdf"; 

/*Close and save PDF document*/
$pdf->Output($pdf_file, 'F');

echo W_RPT."/".$_SESSION['user_id']."-index_list.pdf";
