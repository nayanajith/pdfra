...
$key1					='exam_no';
$grid_array			=array('exam_no','absent','unauthorized','question_no_50');
$grid_array_long	=array('exam_no','absent','unauthorized','question_no_50');
...
echo "<table width=100% style='height:100%'><tr><td style='vertical-align:top'>";
