...
$super_table      ="student";
$key1               ='index_no';
$grid_array         =array('index_no','full_name');
$grid_array_long   =array('index_no','full_name');
...
if(isset($_REQUEST['form'])){
   switch($_REQUEST['form']){
      ...
      case 'grid':
         ...
         $formgen->gen_data_grid($grid_array_long,null,$key1);
   ...
   $formgen->gen_data_grid($grid_array,null,$key1);
   echo "</td></tr></table>";
