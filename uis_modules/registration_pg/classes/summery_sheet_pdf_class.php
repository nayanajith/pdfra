...
class Summery_list{
	...
	public function generate_summery_sheets($res){
	/*
...
<tr><td align="center" colspan="2"><h3>SUMMARY SHEET</h3></td></tr>
</table>';

				$sheet_table='<table border="0" style="border-collapse:collapse" cellpadding="2">';
...
<tr><td align="right">&nbsp;<br><b>Signature of Invigilator:</b></td><td class="fill" ></td><td align="right">&nbsp;<br><b>Signature of  Supervisor:</b></td><td class="fill" ></td></tr>
      		...
      		while($stu_row=mysql_fetch_assoc($stu_res)){
					...
					$SHEET.='<tr>';
      			$SHEET.='<td></td>';	
					$SHEET.='<td align="center" border="1">'.$serial.'</td>';	
					$SHEET.='<td align="center" border="1">'.$stu_row['exam_no'].'</td>';	
      			$SHEET.='<td border="1"></td>';	
      			$SHEET.='<td></td>';	
					$SHEET.="</tr>";
