...
class Index_list{
	...
	public function generate_index_lists($res){
...
<tr><td width="450"><b>Center:</b> '.$center.'</td><td align="right" width="150"><b>Date:</b> '.$this->date.'</td></tr>
<tr><td><b>Hall:</b> '.$hall.'</td><td align="right"><b>Time:</b> '.$this->duration.'</td></tr>
<tr><td><b>Room:</b> '.$room_no.'</td><td align="right"></td></tr>
<tr><td align="center" colspan="2"><h3>LIST OF INDEX NUMBERS</h3></td></tr>
</table>';

				$sheet_table='<table  style="border-collapse:collapse" cellpadding="5" >';
				$sheet_thead='<tr><th width="150px" border="1">Serial No</th><th width="150px" border="1">Index No</th></tr>';
				...
				$rows_per_col=$max_rows/$num_cols;
      		...
      		while($stu_row=mysql_fetch_assoc($stu_res)){
					...
					$col_num=($serial-1)/$rows_per_col;
					$cols[$col_num].='<tr>';
					$cols[$col_num].='<td align="center" border="1">'.$serial.'</td>';	
					$cols[$col_num].='<td align="center" border="1">'.$stu_row['exam_no'].'</td>';	
					$cols[$col_num].="</tr>";

					/*this is how page ends*/
