...
<h4>Instructions</h4>
<ol>
<li>Please download the <a href='?module=registration&page=offline_voucher&data=true'><b>PDF</b></a> file of the payment voucher.
...
<li>The UCSC copy must be sent to UCSC, and please note that Handing over the copy of voucher is compulsory to complete your registration process.
...
<button dojoType='dijit.form.Button' onClick="open_page('registration','payment')">&laquo;&nbsp;Back</button>
</div>
