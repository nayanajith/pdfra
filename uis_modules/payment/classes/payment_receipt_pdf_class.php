...
class Admission{
	...
	*/
	public function add_student_info(){
		...
		$query="SELECT * FROM ".$GLOBALS['MOD_P_TABLES']['user_info']." u, ".$GLOBALS['MOD_P_TABLES']['student_alloc']." s, ".$GLOBALS['MOD_P_TABLES']['exam_hall']." h WHERE u.index_no='".$this->index_no."' AND u.index_no=s.index_no AND s.center_id=h.center_id AND s.hall_id=h.hall_id ";
