...
?>";
         ...
         $admin_add      = mysql_query("INSERT INTO ".$GLOBALS['DB'].".users(username,password,role_id,theme,layout,status,auth_mod)values('admin',md5('admin'),'SUPER','claro','app2','ENABLE','MYSQL')",$con);
