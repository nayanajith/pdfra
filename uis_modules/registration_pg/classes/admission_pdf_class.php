...
class Admission{
	...
	*/
	public function add_student_info(){
		...
		$query="SELECT * FROM ".$GLOBALS['MOD_S_TABLES']['registration']." u, ".$GLOBALS['MOD_S_TABLES']['student_alloc']." s, ".$GLOBALS['MOD_S_TABLES']['exam_hall']." h WHERE u.registration_no='".$this->registration_no."' AND u.registration_no=s.registration_no AND s.center_id=h.center_id AND s.hall_id=h.hall_id ";
