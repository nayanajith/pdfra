...
<tr><td align="right">&nbsp;<br><b>Signature of Invigilator:</b></td><td class="fill" ></td><td align="right">&nbsp;<br><b>Signature of  Supervisor:</b></td><td class="fill" ></td></tr>
				...
				$query="SELECT * FROM ".$GLOBALS['MOD_S_TABLES']['student_alloc']." s, ".$GLOBALS['MOD_S_TABLES']['registration']." u WHERE s.center_id='$center_id' AND s.hall_id = '$hall_id' AND s.room_no='$room_no' AND u.registration_no=s.registration_no ORDER BY exam_no";
