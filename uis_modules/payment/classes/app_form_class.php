...
class Writable_app_form{
	...
	function __construct($table,$filter_table,$key, $key2, $grid_array, $grid_array_long,$data_load_key){
		$this->table				=$table;
		...
		$this->formgen 			= new Formgenerator($table,$key,$file_name=null,$data_load_key);
	}
