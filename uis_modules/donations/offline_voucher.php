...
$reg_arr	=exec_query("SELECT * FROM ".$GLOBALS['MOD_S_TABLES']['registration']." WHERE rec_id='".$_SESSION['user_id']."'",Q_RET_ARRAY);
$reg_arr	=$reg_arr[0];
...
$inv_title	="UCSC DONATION/FUNDING PROGRAM 2011";
