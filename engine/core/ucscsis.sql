...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ucscsis_` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `ucscsis_`;

--
-- Table structure for table `bcsc_batch`
--

DROP TABLE IF EXISTS `bcsc_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bcsc_batch` (
...
--
-- Table structure for table `bit_exam`
--

DROP TABLE IF EXISTS `bit_exam`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bit_exam` (
  `exam_id` char(6) NOT NULL,
  `semester` char(2) DEFAULT NULL,
  `student_year` char(2) DEFAULT NULL,
  `academic_year` char(2) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `time` varchar(15) DEFAULT NULL,
  `venue` varchar(25) DEFAULT NULL,
  `note` varchar(300) DEFAULT NULL,
...
--
-- Table structure for table `bit_gpa`
--

DROP TABLE IF EXISTS `bit_gpa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bit_gpa` (
...
--
-- Table structure for table `bit_mcq_marking_logic`
--

DROP TABLE IF EXISTS `bit_mcq_marking_logic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bit_mcq_marking_logic` (
  ...
  PRIMARY KEY (`question`,`paper_id`),
  KEY `paper_id` (`paper_id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `bit_paper`
--

DROP TABLE IF EXISTS `bit_paper`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bit_paper` (
  `paper_id` int(11) NOT NULL AUTO_INCREMENT,
  `course_id` varchar(50) NOT NULL,
  `exam_id` varchar(50) NOT NULL,
  `examiner` varchar(200) DEFAULT NULL,
  `no_of_questions` int(11) NOT NULL,
  `sections` varchar(20) NOT NULL,
  `answer_file` varchar(200) DEFAULT NULL,
  `marking_logic_file` varchar(200) DEFAULT NULL,
...
--
-- Table structure for table `bit_push`
--

DROP TABLE IF EXISTS `bit_push`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bit_push` (
  `paper_id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `bit_student`
--

DROP TABLE IF EXISTS `bit_student`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bit_student` (
  ...
  `date_of_reg` date DEFAULT '2000-01-01',
  `date_of_grad` date DEFAULT '2000-01-01',
...
CREATE TABLE `program` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=latin1 COMMENT='programs such as BCSc BICT MIS';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `push` (
  ...
  `exam_id` varchar(10) DEFAULT NULL,
  `push` int(3) DEFAULT NULL,
...
-- Dump completed on 2010-11-29  7:17:16
