...
APITITUDE TEST - ".$this->header_info['year'];
	...
	public function admission_config(){
		...
		$this->SetTitle('Selection test admission');
...
<tr><td align="right">&nbsp;<br><b>Signature of Invigilator:</b></td><td class="fill" ></td><td align="right">&nbsp;<br><b>Signature of  Supervisor:</b></td><td class="fill" ></td></tr>
				...
				$query="SELECT * FROM ".$GLOBALS['MOD_P_TABLES']['student_alloc']." s, ".$GLOBALS['MOD_P_TABLES']['registration']." u WHERE s.center_id='$center_id' AND s.hall_id = '$hall_id' AND s.room_no='$room_no' AND u.registration_no=s.registration_no ORDER BY exam_no";
      		...
      		while($stu_row=mysql_fetch_assoc($stu_res)){
					...
					$SHEET.='<td>'.strtoupper($stu_row['last_name']).'</td>';	
