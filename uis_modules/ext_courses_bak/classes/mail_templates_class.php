...
//	   return $mail->mail_attachment($user_info['transaction_id'].".pdf", INVOICE_DIR, $user_info['email'],'PAYMENT_ADMIN_MAIL', "UCSC payment gateway", 'Payment Admin mail', 'UCSC payment status', $body);
	}
